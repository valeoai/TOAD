...
def pdm_score_full_v2(
    ...
    # # infer traffic agents policy and update future observation
    # all_pdms = []
    # for index in tqdm(range(simulated_states.shape[0]-1), desc="Simulating trajectories"):
    #     simulated_agent_detections_tracks = traffic_agents_policy.simulate_environment(simulated_states[index+1], metric_cache)
    ...
    #     _, pdms = scorer.score_proposals(
    #         simulated_states[[0, index+1]],
    #         metric_cache.observation,
    #         metric_cache.centerline,
    #         metric_cache.route_lane_ids,
    #         metric_cache.drivable_area_map,
    ...
    #     )
    #     if index == 0:
    #         all_pdms.append(pdms[0])
    #     all_pdms.append(pdms[-1])
    # pdms = all_pdms
    # assert len(all_pdms) == simulated_states.shape[0], "Length mismatch between pdms and trajectories"
