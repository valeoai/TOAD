...
from navsim.common.dataclasses import PDMResultsV1, Trajectory
from navsim.planning.simulation.planner_v1.pdm_planner.simulation.pdm_simulator import PDMSimulator
from navsim.planning.simulation.planner_v1.pdm_planner.scoring.pdm_scorer import PDMScorer
from navsim.planning.simulation.planner_v1.pdm_planner.utils.pdm_array_representation import ego_states_to_state_array
from navsim.planning.simulation.planner_v1.pdm_planner.utils.pdm_enums import MultiMetricIndex, WeightedMetricIndex
...
def pdm_score(
    ...
    score = float(scores[pred_idx]['pdm_score'].values)
